...
from INPUTJSON2 import run_pipeline_for_facilityid
from INPUTJSON2 import (
...
def main():
    ...
    out_json = r"D:\testpy\NetworkLV66-016716_with_MV.json"
    ...
    # สร้างตัวเช็ค phase จาก JSON (คืนค่าเป็นฟังก์ชัน allowed_for_xy)
    lv_phase_indexer = build_phase_indexer_from_json(json_path)
    logging.info("Optimizing Transformer Location each Group...")
    ...
    out_g1 = os.path.join(os.path.dirname(json_path), f"{base}_G1.dss")
    out_g2 = os.path.join(os.path.dirname(json_path), f"{base}_G2.dss")
