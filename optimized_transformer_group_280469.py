...
def partitionNetworkAtPoint(G, transformerNode, meterNodes, splitting_edge=None):
    ...
    if unassigned:
        ...
        # fallback: จัดเข้าใกล้ฝั่ง u/v ตาม shortest path
        for m in unassigned:
            try:
...
def main():
    ...
    group1_nodes, group2_nodes = partitionNetworkAtPoint(G_for_split, transformerNode, meterNodes, splitting_edge)
    ...
    # initial TX: ใช้ tx_xy ที่อ่านจาก JSON; ถ้าไม่มี ให้เป็น None
